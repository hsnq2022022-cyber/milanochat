...
const SCRIPT: Msg[] = [
  ...
  { from: "idara", text: "السبانش لاتيه عندنا بـ 18 دينار — حار أو مثلج. وعندك كرت الولاء: الكوب السادس مجاني.", time: "9:42 م" },
...
const NOTES = [
  {
    ...
    body: "السعر والمواعيد في المحادثة مسجّلة في بطاقة المشروع — مو تأليف. لاحظ الدقة: 18 دينار، 7ص – 1م.",
  },
  {
