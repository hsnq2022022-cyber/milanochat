...
const ITEMS = [
  ...
  },
  {
    ...
    a: "هنا تتفوق إدارة ســوشـــيــــال: بدل ما يخمّن أو يخترع، يقول بوضوح «ما عندي معلومات مؤكدة» ويعرض تحويل المحادثة لموظف بشري. كل سؤال عجز عنه يظهر لك في اللوحة، فتضيف المعلومة ويصير أدق مع الوقت.",
  },
  {
  ...
  },
  {
    ...
    a: "نعم — أي مشروع عنده أسئلة متكررة: الأسعار، المواعيد، الموقع، التوصيل، سياسة الاسترجاع. إدارة ســوشـــيــــال ترد من بياناتك أنت، فتفاصيل كل نشاط تنعكس في إجاباته بدقة.",
  },
];
