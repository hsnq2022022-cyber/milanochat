...
const ITEMS = [
  {
    ...
    a: "الربط يتم عبر خاصية «الأجهزة المرتبطة» في واتساب — نفس طريقة ربط واتساب ويب على جهازك. وهي ليست قناة رسمية من Meta، لكنها آمنة ومستقرة. وقد تقيّد Meta أي رقم وفق تقديرها.",
  },
  {
  ...
  },
  {
    ...
    a: "لا. تدفع 99 ريال دفعة واحدة تشمل إنشاء الموظف وتدريبه + 1,000 رد ذكي. بعدها تشحن رصيداً فقط وقت ما تحتاج — واحد بواحد.",
  },
  {
