...
const ITEMS = [
  {
    ...
    a: "نعم، الربط رسمي 100%. نستخدم WhatsApp Cloud API الرسمية من Meta مباشرة — نفس القناة المعتمدة للشركات، بدون أجهزة مرتبطة أو متصفح. الاتصال مستقر وآمن ولا يعتمد على جهازك الشخصي.",
  },
  {
    q: "ماذا لو سأل العميل عن شي ما عندك فيه معلومة؟",
    a: "هنا يتفوق موظف إدارة ســوشـــيــــال: بدل ما يخمّن أو يخترع، يقول بوضوح «ما عندي معلومات مؤكدة» ويعرض تحويل المحادثة لموظف بشري أو لك مباشرة.",
  },
  {
    q: "هل فيه اشتراك شهري؟",
    a: "لا. تدفع 40,000 دينار دفعة واحدة تشمل إنشاء الموظف وتدريبه + 1,000 رد ذكي. بعدها تشحن رصيداً فقط وقت ما تحتاج — واحد بواحد.",
  },
  {
  ...
  },
  {
    ...
    a: "نعم — أي مشروع عنده أسئلة متكررة: الأسعار، المواعيد، الموقع، التوصيل، سياسة الاسترجاع. موظفك يرد من بياناتك أنت، فتفاصيل كل نشاط تنعكس في إجاباته بدقة.",
  },
];
    ...
    >
      <div className="max-w-4xl mx-auto px-5 lg:px-8">
        <div className="text-center mb-12">
          <p
            data-reveal
            className="font-display font-bold text-oro text-lg mb-2"
          >
            — قبل ما تسألنا
          </p>
          ...
          <h2
            ...
            className="font-display font-extrabold text-4xl sm:text-5xl text-bone"
          >
            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all duration-400 overflow-hidden ${
                  isOpen
                    ? "bg-moss/80 border-oro/40 shadow-[0_20px_50px_-25px_rgba(232,178,75,0.3)]"
                    : "bg-pine/70 border-verde/15 hover:border-verde/35"
                }`}
              >
                <button
                ...
                >
                  ...
                  <span
                    className={`w-8 h-8 rounded-full border flex items-center justify-center shrink-0 transition-all duration-400 ${
                      isOpen
                        ? "bg-oro text-ink border-oro rotate-45"
                ...
                >
                  <div className="overflow-hidden">
                    <p className="px-5 sm:px-6 pb-5 text-sm text-sage leading-8 max-w-2xl">
                      {item.a}
                    </p>
                  </div>
                </div>
        ...
        >
          <p className="text-sm text-sage">
            سؤالك مو موجود؟ موظف إدارة ســوشـــيــــال نفسه يرد عليك الآن:
          </p>
